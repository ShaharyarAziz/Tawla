...
```ts
  ...
  4  |   constructor(page) {
  5  |     this.page = page;
  6  |     this.avatar = page.locator("img[alt='User Profile']");
  7  |     // this.logout_btn = page.locator(`a[href="${URLS.logout}"]`);
  8  |     // this.logout_btn = page.locator(
  9  |     //   'a[href="http://13.51.170.24/merchant/logout"]',
  10 |     // );
  11 |     this.logout_btn = page.locator('a[onclick="localStorage.clear();"]');
  12 |   }
  13 |   async navigate() {
> 14 |     await this.page.goto(URLS.login);
     |                     ^ Error: page.goto: Test timeout of 30000ms exceeded.
  15 |   }
  16 | }
  17 | 
