...
Call log:
  - waiting for locator('a.logout-btn') to be visible
    12 × locator resolved to hidden <a class="logout-btn" onclick="localStorage.clear();" href="http://13.51.170.24/merchant/logout">Logout</a>
