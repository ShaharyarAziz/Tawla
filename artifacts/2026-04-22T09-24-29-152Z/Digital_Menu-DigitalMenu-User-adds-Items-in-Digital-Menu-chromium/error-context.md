...
Call log:
  - waiting for getByRole('option', { name: 'Vegeterian' })
...
```ts
  ...
  7  |     this.vegeterian = this.page.getByRole("option", {
  8  |       name: "Vegeterian",
  9  |     });
  10 |     this.nonVegeterian = this.page.getByRole("option", {
  11 |       name: "Non-Vegeterian",
  12 |     });
  13 |   }
  14 |   async openCreateItemModal() {
  15 |     await this.createItemBtn.click();
  16 |   }
  17 |   async saveItem(name) {
  18 |     await this.item_name.fill(name);
  19 |     await this.foodtypeDropdown.click();
> 20 |     await this.vegeterian.click();
     |                           ^ TimeoutError: locator.click: Timeout 10000ms exceeded.
  21 |     await this.nonVegeterian.click();
  22 |   }
  23 | }
