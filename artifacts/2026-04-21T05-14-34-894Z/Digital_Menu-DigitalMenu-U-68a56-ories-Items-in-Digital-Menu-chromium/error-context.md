...
```
Error: locator.click: Error: strict mode violation: locator('span[role="combobox"]').locator('span') resolved to 6 elements:
    1) <span role="textbox" aria-readonly="true" class="select2-selection__rendered" id="select2-for_catergories-container">…</span> aka locator('#select2-for_catergories-container')
    2) <span class="select2-selection__placeholder">Select a category</span> aka getByLabel('Select a category').getByText('Select a category')
    3) <span role="presentation" class="select2-selection__arrow">…</span> aka locator('.select2-selection__arrow').first()
    4) <span role="textbox" aria-readonly="true" class="select2-selection__rendered" id="select2-lang_for_catergories-container">…</span> aka locator('#select2-lang_for_catergories-container')
    5) <span class="select2-selection__placeholder">اختر فئة</span> aka getByLabel('اختر فئة').getByText('اختر فئة')
    6) <span role="presentation" class="select2-selection__arrow">…</span> aka locator('.select2.select2-container.select2-container--default.select2-container--disabled > .selection > .select2-selection > .select2-selection__arrow')

Call log:
  - waiting for locator('span[role="combobox"]').locator('span')
...
```ts
  ...
  7  |       .locator("span");
  8  |     this.dropdownOptions = this.page.getByText("Recycled Cotton Cheese").nth(5);
...
> 17 |     await this.selectCategoryDropdown.click();
     |                                       ^ Error: locator.click: Error: strict mode violation: locator('span[role="combobox"]').locator('span') resolved to 6 elements:
  18 |     await this.dropdownOptions.click();
  19 |     await this.itemselect.click();
  20 |   }
  21 | }
  22 | module.exports = Sub_Category;
  23 | 
```