...
```ts
  ...
  11 |     this.foodtypeDropdown = this.page.locator("span#food-type-label");
  ...
  39 |     await this.foodtypeDropdown.click({ force: true });
> 40 |     await this.vegeterian.click();
  ...
  57 |     await this.page.pause();
  58 |   }
  59 | }
  60 | module.exports = { items };
  61 | 
```