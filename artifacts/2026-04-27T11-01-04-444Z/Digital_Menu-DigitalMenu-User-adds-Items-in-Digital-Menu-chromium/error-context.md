...
```
Error: locator.click: Error: strict mode violation: locator('.custom-dropdown-wrapper') resolved to 3 elements:
...
Call log:
  - waiting for locator('.custom-dropdown-wrapper')
            ...
            - generic [ref=e98]:
              - generic [ref=e99]:
                - generic [ref=e100]:
                  ...
                  - textbox "Item Name" [active] [ref=e102]: Spicy Pizza
                - generic [ref=e103]:
