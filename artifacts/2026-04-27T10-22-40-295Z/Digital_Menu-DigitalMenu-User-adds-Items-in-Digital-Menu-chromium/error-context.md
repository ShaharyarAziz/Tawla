...
Call log:
  - waiting for locator('input[value="vegetarian"]') to be visible
    63 × locator resolved to hidden <input type="checkbox" value="vegetarian" class="food-type-checkbox custom-checkbox"/>
...
> 40 |     await this.vegeterian.waitFor({ state: "visible", timeout: 30000 });
     |                           ^ TimeoutError: locator.waitFor: Timeout 30000ms exceeded.
  41 |     await this.vegeterian.click();
