...
```ts
  ...
  71  | 
  72  |     // 🔥 FOOD TYPE
  73  |     await this.foodtypeDropdown.click();
  74  | 
  75  |     await this.page
  76  |       .locator("#food-type-dropdown span", { hasText: "Vegetarian" })
  77  |       .first()
  78  |       .click();
  79  | 
  80  |     // ✅ VERY IMPORTANT: close dropdown to avoid overlay blocking
  81  |     await this.page.keyboard.press("Escape");
  82  | 
  83  |     // 🔥 PRICE
  84  |     await this.item_price.fill(price);
  85  | 
  86  |     // 🔥 CATEGORY
> 87  |     await this.categoryNameDropdown.click();
      |                                     ^ TimeoutError: locator.click: Timeout 10000ms exceeded.
  88  | 
  89  |     await this.page
  90  |       .locator("#category-dropdown span", { hasText: "Recycled Cotton Cheese" })
  91  |       .first()
  92  |       .click();
  93  | 
  94  |     await this.page
  95  |       .locator("#category-dropdown span", { hasText: "Modern Marble Hat" })
  96  |       .first()
  97  |       .click();
  98  | 
  99  |     // 🔥 SUBCATEGORY
  100 |     await this.subCategoryDropdown.click();
  101 | 
  102 |     await this.scrollAndSelectSubCategory("Spicy Fries");
  103 | 
