...
Call log:
  - waiting for locator('#dropdownMenu') to be visible
    24 × locator resolved to hidden <div id="dropdownMenu" class="dropdown-content">…</div>
...
```ts
  ...
  21 | 
  22 |     // ✅ wait for dropdown container (NOT logout)
> 23 |     await logout.menu.waitFor({ state: "visible" });
     |                       ^ TimeoutError: locator.waitFor: Timeout 10000ms exceeded.
  24 | 
  25 |     // now click logout
