...
- Location: tests\Digital_Menu\DigitalMenu.spec.js:15:6
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    4 × unexpected value "http://13.51.170.24/merchant/login"
...
- generic [ref=e4]:
  - generic [ref=e6]:
    - generic:
      - img "Tawla logo"
    - generic [ref=e7]:
      - heading "All-in-One POS & Restaurant Management" [level=2] [ref=e8]
      - paragraph [ref=e9]: Manage orders, payments, bookings, and more — all from one platform.
  - generic [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]:
          ...
          - textbox "Email Address Please Enter Your Email Address" [active] [ref=e16]:
            - /placeholder: Enter Your Email
        - generic [ref=e17]:
          - generic [ref=e18]: Password
          - generic [ref=e19]:
            - textbox "Password Password is required" [ref=e20]:
      ...
      - generic [ref=e28]: Or you can
      - link "Register Now" [ref=e30] [cursor=pointer]:
        - /url: http://13.51.170.24/merchant/demo-request
    - paragraph [ref=e31]: Your information is secure and confidential.
```
...
```ts
  ...
  13 | dotenv.config();
  14 | 
  15 | test.only("User adds Categories in Digital Menu", async ({ page }) => {
