...
```
TypeError: this.foodtypeDropdown.toBeVisible is not a function
```
            ...
            - generic [ref=e98]:
              - generic [ref=e99]:
                - generic [ref=e100]:
                  ...
                  - textbox "Item Name" [active] [ref=e102]: Grilled Pizza
                - generic [ref=e103]:
...
> 39 |     await this.foodtypeDropdown.toBeVisible({ timeout: 30000 });
     |                                 ^ TypeError: this.foodtypeDropdown.toBeVisible is not a function
