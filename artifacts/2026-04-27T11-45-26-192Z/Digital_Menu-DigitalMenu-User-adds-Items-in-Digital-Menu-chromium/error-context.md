...
> 41 |     await dropdown.scrollIntoViewIfNeeded();
     |     ^ ReferenceError: dropdown is not defined
  42 | 
  43 |     const box = await dropdown.boundingBox();
  44 | 
  45 |     await this.page.mouse.click(box.x + 5, box.y + 5);
  46 |     await this.foodtypeDropdown.click();
