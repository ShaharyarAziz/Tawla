...
Call log:
  - waiting for getByRole('button', { name: 'Save Category' })
    - locator resolved to <button type="button" class="btn category-save-btn submitAddMainCategory">…</button>
          ...
          - generic [ref=e97]:
            - generic [ref=e98]:
              - generic [ref=e99]:
                ...
                - textbox "Enter Category Name" [active] [ref=e101]: Cheesy Pizza
              - separator [ref=e102]
