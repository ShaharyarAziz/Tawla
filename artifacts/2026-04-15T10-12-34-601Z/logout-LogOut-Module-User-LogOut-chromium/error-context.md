...
Call log:
  - waiting for locator('a[href="http://13.51.170.24/merchant/logout"]') to be visible
    24 × locator resolved to hidden <a class="logout-btn" onclick="localStorage.clear();" href="http://13.51.170.24/merchant/logout">Logout</a>
