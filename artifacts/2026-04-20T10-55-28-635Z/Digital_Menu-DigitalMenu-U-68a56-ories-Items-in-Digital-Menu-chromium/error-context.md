          ...
          - generic [ref=e97]:
            - generic [ref=e98]:
              - generic [ref=e99]:
                ...
                - textbox "Enter Category Name" [ref=e101]: Tasty Aluminum Gloves
              - separator [ref=e102]
              - generic [ref=e104]: Add Arabic Translation
            - generic [ref=e108]:
              - button "Cancel" [ref=e109] [cursor=pointer]
              - button "Save Category" [disabled] [ref=e110]: Save Category
      - generic [ref=e112]:
        - heading "Super Admins" [level=2] [ref=e113]
        - textbox "Search Menu Item" [ref=e116]
```
...
> 27 |   await expect(category.successToastMessage()).toHaveText(
     |                                                ^ Error: toHaveText can be only used with Locator object
  28 |     "Category created successfully",
  29 |   );
  30 |   await page.pause();
  31 | });
  32 | 
