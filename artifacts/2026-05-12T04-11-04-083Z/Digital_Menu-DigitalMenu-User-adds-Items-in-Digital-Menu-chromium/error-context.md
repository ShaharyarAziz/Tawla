...
```ts
  ...
  26  |     this.categoryDropdown = page.locator('div.custom-dropdown-trigger[data-dropdown="category-dropdown"]');
...
> 81  |     await this.foodtypeMenu.waitFor({ state: "visible" });
  ...
  98  |     await this.scrollAndSelectSubCategory("Strawberry with Belgian chocolate");
  99  |         await this.scrollAndSelectSubCategory("Milkshakes");
  100 | 
  101 | 
