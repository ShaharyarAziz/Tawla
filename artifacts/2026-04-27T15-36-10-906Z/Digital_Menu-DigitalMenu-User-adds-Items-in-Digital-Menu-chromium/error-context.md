...
Call log:
  - waiting for locator('#subcategory-options div').filter({ hasText: 'Spicy Fries' }).first()
            ...
            - generic [ref=e117]:
              - generic [ref=e118]:
                - generic [ref=e119]:
                  ...
                  - textbox "Item Name" [ref=e121]: BBQ Pizza
                - generic [ref=e122]:
...
```ts
  ...
  30 |       .locator("#subcategory-options div") // each row
  31 |       .filter({ hasText: "Spicy Fries" })
  32 |       .first();
  ...
  43 |     await this.vegeterian.click();
