...
```
Error: locator.click: Error: strict mode violation: getByText('Create Sub Category') resolved to 2 elements:
    1) <a data-toggle="modal" class="btn btn-theme-simple" data-target="#subCategoryModel">↵                                    + Create Sub…</a> aka getByText('+ Create Sub Category')
    2) <h2 class="sub_cat_heading">Create Sub Category</h2> aka getByRole('heading', { name: 'Create Sub Category' })
            ...
            - generic [ref=e98]:
              - generic [ref=e99]:
                ...
                - generic [ref=e108]:
                  ...
                  - textbox "Enter Sub Category" [active] [ref=e110]: Hot Biryani
...
```ts
  ...
  14 |     this.saveSubCategoryBtn = page.getByText("Create Sub Category");
  15 |   }
...
> 26 |     await this.saveSubCategoryBtn.click();
  ...
  27 |   }
  28 | }
  29 | module.exports = Sub_Category;
  30 | 
```