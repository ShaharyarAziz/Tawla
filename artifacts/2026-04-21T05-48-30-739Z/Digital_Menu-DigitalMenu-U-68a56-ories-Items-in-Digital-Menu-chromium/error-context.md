        ...
        - generic [ref=e90]:
          ...
          - generic [ref=e97]:
            - generic [ref=e98]:
              ...
              - separator [ref=e130]
              - generic [ref=e132]: Add Arabic Translation
            - generic [ref=e136]:
              - button "Cancel" [ref=e137] [cursor=pointer]
              - button "Save Sub Category" [ref=e138] [cursor=pointer]
      - generic [ref=e139]:
        - heading "Super Admins" [level=2] [ref=e140]
        - textbox "Search Menu Item" [ref=e143]
```
...
```ts
  ...
  13 |     // this.imageUploadInput = page
  14 |     //   .locator("#subcat_image")
  15 |     //   .setInputFiles("utils/1764155658-ARUGULA STEAK.webp");
  16 |   }
  17 |   async openSubCategoryModal() {
  18 |     await this.createSubCategoryBtn.click();
  19 |   }
  20 |   async saveSubCategory(name) {
  21 |     await this.selectCategoryDropdown.click();
  22 |     await this.dropdownOptions.click();
> 23 |     await this.enterSubCategoryNameInput.fill();
     |                                          ^ Error: locator.fill: value: expected string, got undefined
  24 |     // await this.imageUploadInput;
  25 |   }
  26 | }
  27 | module.exports = Sub_Category;
  28 | 
```