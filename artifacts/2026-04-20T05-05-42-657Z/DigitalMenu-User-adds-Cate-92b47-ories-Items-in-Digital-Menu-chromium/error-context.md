...
Received: "http://13.51.170.24/merchant/digitalmenu/menu/digitalMenuSection"
Timeout:  5000ms
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    ...
    2 × unexpected value "http://13.51.170.24/merchant/dashboard"
    - waiting for" http://13.51.170.24/merchant/digitalmenu/menu/digitalMenuSection" navigation to finish...
    - navigated to "http://13.51.170.24/merchant/digitalmenu/menu/digitalMenuSection"
    3 × unexpected value "http://13.51.170.24/merchant/digitalmenu/menu/digitalMenuSection"
...
```ts
  ...
  12 |   await login.navigate();
  13 |   await login.login(process.env.EMAIL, process.env.PASSWORD);
> 14 |   await expect(page).toHaveURL("merchant/dashboard/");
     |                      ^ Error: expect(page).toHaveURL(expected) failed
  15 |   await digitalMenu.goToDigitalMenu();
  16 | });
  17 | 
```