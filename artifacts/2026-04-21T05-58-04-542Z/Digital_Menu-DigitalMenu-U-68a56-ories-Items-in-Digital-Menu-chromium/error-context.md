...
Call log:
  - waiting for getByRole('button', { name: 'Create Sub Category' })
            ...
            - generic [ref=e98]:
              - generic [ref=e99]:
                ...
                - generic [ref=e108]:
                  ...
                  - textbox "Enter Sub Category" [active] [ref=e110]: BBQ Fries
...
```ts
  ...
  14 |     this.saveSubCategoryBtn = page.getByRole("button", {
  15 |       name: "Create Sub Category",
  16 |     });
  17 |   }
