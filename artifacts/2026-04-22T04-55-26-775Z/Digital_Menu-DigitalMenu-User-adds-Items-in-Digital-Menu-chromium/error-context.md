...
Call log:
  - waiting for locator('#food-type-dropdown')
    - locator resolved to <div id="food-type-dropdown" class="custom-dropdown-menu">…</div>
            ...
            - generic [ref=e98]:
              - generic [ref=e99]:
                - generic [ref=e100]:
                  ...
                  - textbox "Item Name" [active] [ref=e102]: Spicy Burger
                - generic [ref=e103]:
...
```ts
  ...
  6  |     this.foodtypeDropdown = page.locator("#food-type-dropdown");
