...
```ts
  ...
  12 |   }
  13 | 
  14 |   // ✅ action method (VERY IMPORTANT)
  15 |   async logout() {
  16 |     await this.avatar.click();
  17 | 
  18 |     // wait until ANY logout becomes visible
> 19 |     await this.page.waitForSelector(".logout-btn:visible", { timeout: 5000 });
     |                     ^ TimeoutError: page.waitForSelector: Timeout 5000ms exceeded.
  20 | 
  21 |     await this.page.locator(".logout-btn:visible").click();
  22 |   }
  23 | }
  24 | 
```