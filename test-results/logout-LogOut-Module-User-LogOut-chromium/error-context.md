...
- Location: tests\logout.spec.js:5:7
...
Call log:
  - waiting for locator('a.logout-btn')
    - locator resolved to <a class="logout-btn" onclick="localStorage.clear();" href="http://13.51.170.24/merchant/logout">Logout</a>
      ...
      - generic [ref=e273]:
        - generic [ref=e274]:
          ...
          - generic [ref=e276]:
            - img [ref=e277]
            - generic [ref=e278]:
              - paragraph [ref=e279]: "New Order: Strawberry with chocolate Small for table N/A"
              - text: 19 hours ago
        - generic [ref=e280]:
          ...
          - generic [ref=e282]:
            - img [ref=e283]
            - generic [ref=e284]:
              - paragraph [ref=e285]: "New Order: Strawberry with chocolate Small for table Test Table"
              - text: 20 hours ago
        - generic [ref=e286]:
          ...
          - generic [ref=e288]:
            - img [ref=e289]
            - generic [ref=e290]:
              - paragraph [ref=e291]: "New Order: Test_Dinner for table N/A"
              - text: 1 day ago
        - generic [ref=e292]:
        ...
        - generic [ref=e298]:
          ...
          - generic [ref=e300]:
            - img [ref=e301]
            - generic [ref=e302]:
              - paragraph [ref=e303]: "New Order: Test_Dinner for table testbranch"
              - text: 1 week ago
```
...
```ts
  ...
  2  | import { LogOutPage } from "../pages/Logout";
  3  | import { LoginPage } from "../pages/LoginPage";
  4  | test.describe("LogOut Module", () => {
  5  |   test("User LogOut", async ({ page }) => {
  6  |     const logout = new LogOutPage(page);
  7  |     const login = new LoginPage(page);
  8  |     await logout.navigate();
  9  |     await login.login(process.env.EMAIL, process.env.PASSWORD);
  10 |     await logout.avatar.click();
> 11 |     await logout.logout_btn.click();
     |                             ^ TimeoutError: locator.click: Timeout 10000ms exceeded.
  12 |     await expect(page).toHaveURL("/merchant/login");
  13 |     // await page.pause();
  14 |   });
  15 | });
  16 | 
